...
/*
  Create a construcre make and model will come from two parameters, make and model (in that order).
*/
...
// Do not edit the code below.
  ...
  */
  ...
  // age will be a number and savedPosts will be an array of objects. These objects will each have 3 properties: id (a number), title (a string), and rating (a number between 1 and 5).
